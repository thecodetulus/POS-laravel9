              ...
              <div class="card gradient-bottom">
                ...
                <div class="card-body" id="top-5-scroll">
                  <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="../stisla/img/products/product-3-50.png" alt="product">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="../stisla/img/products/product-4-50.png" alt="product">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="../stisla/img/products/product-1-50.png" alt="product">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="../stisla/img/products/product-5-50.png" alt="product">
                      <div class="media-body">
                  ...
                  <div class="owl-carousel owl-theme" id="products-carousel">
                    <div>
                      <div class="product-item pb-3">
                        <div class="product-image">
                          <img alt="image" src="../stisla/img/products/product-4-50.png" class="img-fluid">
                        </div>
                    ...
                    <div>
                      <div class="product-item">
                        <div class="product-image">
                          <img alt="image" src="../stisla/img/products/product-3-50.png" class="img-fluid">
                        </div>
                        <div class="product-details">
                    ...
                    <div>
                      <div class="product-item">
                        <div class="product-image">
                          <img alt="image" src="../stisla/img/products/product-1-50.png" class="img-fluid">
                        </div>
                        <div class="product-details">
